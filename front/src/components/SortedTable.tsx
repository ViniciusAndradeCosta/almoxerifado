        ...
        <tbody>
          {sortedData.map((row, index) => (
            <tr key={index}>
              ...
              <td>
                <button onClick={() => onVisualize(row.id as number)} className="btn btn-primary me-2">
                  Visualizar
                </button>
                <button onClick={() => onUpdate(row.id as number)} className="btn btn-warning me-2">
                  Atualizar
                </button>
                <button className="btn btn-danger" onClick={() => onDelete(row.id as number)}>
                  Excluir
                </button>
              </td>
            </tr>
